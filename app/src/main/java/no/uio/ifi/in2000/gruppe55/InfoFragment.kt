...
class InfoFragment: Fragment(){
    ...
    private var stationRef = "2019-04-30T01:00:00Z"
    ...
    private fun setGraph(tempList: MutableList<Double?>){
        ...
        val series = LineGraphSeries<DataPoint>(arrayOf<DataPoint>(
            DataPoint(tempList[0]!!, 0.0),
            DataPoint(tempList[1]!!, 1.0),
            DataPoint(tempList[2]!!, 2.0),
            DataPoint(tempList[3]!!, 3.0),
            DataPoint(tempList[4]!!, 4.0),
            DataPoint(tempList[5]!!, 5.0),
            DataPoint(tempList[6]!!, 6.0),
            DataPoint(tempList[7]!!, 7.0),
            DataPoint(tempList[8]!!, 8.0),
            DataPoint(tempList[9]!!, 9.0),
            DataPoint(tempList[10]!!, 10.0),
            DataPoint(tempList[11]!!, 11.0)
        ))
